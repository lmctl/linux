...
static int cap_kdbus_alloc(struct kdbus_conn *conn)
{
	return 0;
}

static void cap_kdbus_free(struct kdbus_conn *conn)
{
}

static int cap_kdbus_send(struct kdbus_conn *src, struct kdbus_conn *dst)
{
	return 0;
}

static int cap_kdbus_recv(struct kdbus_conn *src, struct kdbus_conn *dst)
{
	return 0;
}
...
void __init security_fixup_ops(struct security_operations *ops)
{
	...
	set_to_cap_if_null(ops, kdbus_alloc);
